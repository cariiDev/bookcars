...
//
// Validation endpoints - Allow guest access for checkout
routes.route(routeNames.validateVoucher).post(voucherController.validateVoucher)
routes.route(routeNames.validateStackableVouchers).post(voucherController.validateStackableVouchers)
routes.route(routeNames.findBestVoucherCombination).post(voucherController.findBestVoucherCombination)
