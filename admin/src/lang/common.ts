...
const strings = new LocalizedStrings({
  fr: {
    ...
    IC_NUMBER: 'Numéro de carte d\'identité',
    UPLOAD_IC: 'Charger un document d\'identité...',
    STUDENT_ID: 'ID étudiant',
    UPLOAD_STUDENT_ID: 'Charger un document étudiant...',
    IC_NUMBER_NOT_VALID: 'Numéro de carte d\'identité non valide',
    LICENSE_EXPIRY_DATE_NOT_VALID: 'La date d\'expiration doit être dans le futur',
  ...
  en: {
    ...
    IC_NUMBER: 'IC Number',
    UPLOAD_IC: 'Upload ID document...',
    STUDENT_ID: 'Student ID',
    UPLOAD_STUDENT_ID: 'Upload student ID...',
    IC_NUMBER_NOT_VALID: 'Invalid IC number format (YYMMDD-PB-###G)',
    LICENSE_EXPIRY_DATE_NOT_VALID: 'License expiry date must be in the future',
  ...
  es: {
    ...
    IC_NUMBER: 'Número de tarjeta de identidad',
    UPLOAD_IC: 'Subir documento de identidad...',
    STUDENT_ID: 'ID de estudiante',
    UPLOAD_STUDENT_ID: 'Subir documento de estudiante...',
    IC_NUMBER_NOT_VALID: 'Formato de número de tarjeta de identidad no válido',
    LICENSE_EXPIRY_DATE_NOT_VALID: 'La fecha de vencimiento debe ser en el futuro',
